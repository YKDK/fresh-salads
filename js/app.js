(() => {
    ...
    if (location.href.includes(`menu`)) {
        menuSearch.className = "menu__search _icon-search color-search";
        headerContainer.classList.add("salad-menu");
    }
    const menuName = document.querySelectorAll(".menu-content__name");
    menuName.forEach((nameItem => {
        nameItem.addEventListener("mouseenter", mouseAction);
        nameItem.addEventListener("mouseleave", mouseAction);
        function mouseAction(e) {
            if ("mouseenter" === e.type) {
                const menuContentItem = nameItem.closest(".menu-content__item");
                if (menuContentItem) {
                    menuContentItem.classList.add("img-scale");
                    console.log("123");
                }
            }
            if ("mouseleave" === e.type) {
                const menuContentItem = nameItem.closest(".menu-content__item");
                if (menuContentItem) {
                    menuContentItem.classList.remove("img-scale");
                    console.log("123");
                }
            }
            e.preventDefault();
